      ...
      floatingActionButton: ButtonWidgets(
        ...
        body: SafeArea(
          ...
          Container(
            ...
            child: AppBarWidget(leading: BackButtonWidgets(ontap: () => context.read<AuthCubit>().changeState(AuthId())),text: "Your Personal ID"),
          ),
          Expanded(
            child: Padding(
              ...
              child: SizedBox(
                child: Column(
                  children: [
                    ...
                    const Text("Doctors use your ID to have an access to your medical informations. We have sent this ID and your password to your number so you don’t forget them", style: FontStyles.headline4s, textAlign: TextAlign.center,),
                    SizedBox(height: context.h * 0.04),
                    SizedBox(
                      width: context.w,
                      child: const Text("Your ID", style: FontStyles.headline3s)),
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            decoration: BoxOnlyDecoration.decor(ColorConst.grey, topLeft: 10.0, bottomLeft: 10.0),
                            child: const Text("12345678", style: FontStyles.headline4s)
                          ),
                        ),
                          InkWell(
                            child: Container(
                              ...
                              child: const Text("Copy",style: FontStyles.headline3s)
                            ),
                            onTap: (){
